...
ghenv.Component.Name = "LBT2PH_SetSystems"
...
if distict_heating_:  hc.update( {'distict_heating'.id:distict_heating_.to_dict()} )
if supply_air_cooling_: hc.update( {'supply_air_cooling'.id:supply_air_cooling_.to_dict()} )
if recirc_air_cooling_: hc.update( {'recirc_air_cooling'.id:recirc_air_cooling_.to_dict()} )
if addnl_dehumid_:     hc.update( {'addnl_dehumid'.id:addnl_dehumid_.to_dict()} )
if panel_cooling_:  hc.update( {'panel_cooling'.id:panel_cooling_.to_dict()} )

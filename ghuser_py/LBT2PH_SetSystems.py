...
Leave blank if no secondary heat generation equipment is used.
    ...
    Returns:
        HB_rooms_: DataTree. Branch 1 is all the 'PER' related information (heating fractions). Branch 2 is all the Heating / Cooling Equipment related data. Connect to the 'Heating_Cooling_' input on the '2PHPP | Setup' Component.
"""

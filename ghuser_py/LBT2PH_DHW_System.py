...
EM February 27, 2021
    Args:
        ...
        Note - Optionally, pass in the string 'default' in order to assign a default tank with a heat loss rate of 4 W/k.
        buffer_tank_: The DHW buffer tank (if any) used. Heating Only. Input the results of a 'DHW Tank' component.
        ['DHW+Distribution', Cells P186:P204]
        _solar: (Optional) A Solar-Thermal hot-water system. Connect to a "DHW | Solar Thermal" component.
    Returns:

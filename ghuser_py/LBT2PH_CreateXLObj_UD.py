...
#
"""
For writing a user-determined custom value to any range on any worksheet. Be careful with this! It'll let you write anyplace in the Excel workbook - be cautious not to accidentaly overwrite an important formula in the PHPP or cause some other unintendded error.
-
EM December 23, 2020
    Args:
...
ghenv.Component.Name = "LBT2PH_CreateXLObj_UD"
ghenv.Component.NickName = "UD XL Obj"

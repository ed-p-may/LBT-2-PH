...
EM March 1, 2021
    Args:
        ...
        usage_: The Usage Profile object decribing DHW litres/person/day of HW at 
        ...
        circulation_piping_: The Recirculation Piping (not including branches). 
            This is only used if there is a recirc loop in the project. Connect a 
            'Pipping | Recirc' component here.
        ...
        tank2_: The secondary DHW tank (if any) used. Input the results of a 'DHW Tank' component.
            ...
            Note - Optionally, pass in the string 'default' in order to assign a 
            default tank with a heat loss rate of 4 W/k.
        buffer_tank_: The DHW buffer tank (if any) used. Heating Only. Input the 
            results of a 'DHW Tank' component.
            ['DHW+Distribution', Cells P186:P204]
        _solar: (Optional) A Solar-Thermal hot-water system. Connect to a 
            "DHW | Solar Thermal" component.
    Returns:
        dhw_: The combined DHW System object with all params. Connect this to 
            the 'dhw_' input on the 'Create Excel Obj - Setup' component to use.
"""

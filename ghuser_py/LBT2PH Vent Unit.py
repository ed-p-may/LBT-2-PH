...
EM March 1, 2021
    Args:
        ...
        Elec_Eff_: <Optional> Input the Electrical Efficiency of the Ventialtion 
            Unit (W/m3h). Default is 0.45 W/m3h
    Returns:
        ventUnit_: A Ventilator object for the Ventilation System. Connect to the 
            'ventUnit_' input on the 'Create Vent System' to build a PHPP-Style Ventialtion System.
"""
...
ghenv.Component.Name = "LBT2PH Vent Unit"

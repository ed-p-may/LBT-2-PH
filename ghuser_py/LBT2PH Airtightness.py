...
EM March 1, 2021
    ...
    Returns:
        ...
        infiltrationRatePerFacadeArea_: (m3/hr-m2-facade) Connect to the 
            'infilRatePerArea_Facade_' input on the Honeybee 'setEPZoneLoads' Component
"""
...
ghenv.Component.Name = "LBT2PH Airtightness"
